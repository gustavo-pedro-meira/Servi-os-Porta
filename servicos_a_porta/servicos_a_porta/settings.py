"""
Django settings for servicos_a_porta project.
...
SECRET_KEY = 'django-insecure-$b#@@zrtyetw#4n2$rbb=0xubzz87w5ha^!2f!(7gi0ys56#i%'
...
WSGI_APPLICATION = 'servicos_a_porta.wsgi.application'
