...
class ProfissionalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Profissional
        fields = ["id", "nome", "dataNascimento", "descricao", "nivel_profissional", "foto_perfil" , "idProfissao", "cpf", "cep", "estado", "cidade", "dataInicio", "profissao", "username", "numero", "email", "password"]
